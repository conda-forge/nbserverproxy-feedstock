About nbserverproxy-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbserverproxy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4480&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbserverproxy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbserverproxy` can be installed with `conda`:
...
```
mamba install nbserverproxy
```

It is possible to list all of the versions of `nbserverproxy` available on your platform with `conda`:
...
```
mamba search nbserverproxy --channel conda-forge
```
...
mamba repoquery search nbserverproxy --channel conda-forge

# List packages depending on `nbserverproxy`:
mamba repoquery whoneeds nbserverproxy --channel conda-forge

# List dependencies of `nbserverproxy`:
mamba repoquery depends nbserverproxy --channel conda-forge
```
